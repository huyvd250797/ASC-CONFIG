...
Toàn bộ phần điều khiển (thanh tiêu đề, tab Loại, ô tìm kiếm, bộ lọc, phân trang) được ghim
cố định; **chỉ vùng dữ liệu là cuộn được**, nên không còn cảnh vừa cuộn trang vừa cuộn lưới.
Thanh lọc dồn nhãn về cùng hàng với ô chọn để luôn vừa một màn hình.

Khi popup chi tiết mở ra, nền bị khoá cuộn hoàn toàn — chỉ cuộn được bên trong popup.
