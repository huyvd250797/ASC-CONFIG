...
Nút mũi tên vòng trên thanh tiêu đề đưa **toàn bộ app về hiện trạng ban đầu**: xóa từ khóa,
bỏ bộ lọc Phân hệ và Module, quay về tab CONFIG, kiểu xem lưới, sắp xếp theo STT tăng dần,
hiển thị tất cả dòng, về trang đầu, đóng popup, bật lại realtime — rồi tải lại dữ liệu từ
Google Sheet.

Phân biệt với hai nút cạnh bên: nút mũi tên tròn chỉ **tải lại dữ liệu** mà giữ nguyên bộ lọc,
còn nút biểu tượng phễu ở thanh lọc chỉ **xóa bộ lọc và từ khóa** mà không đụng tới kiểu xem
hay phân trang.
...
chi tiết. Popup chi tiết có thêm nút chép mã, chép Value và chép script.
